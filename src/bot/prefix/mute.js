...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!message.member.permissions.has(PermissionsBitField.Flags.Administrator)) return message.channel.send("You don't have permissions to mute members.");
    if(!timeUser) return message.channel.send("Please mention a member to mute.");
