...
module.exports = {
  ...
  run: async (client, message, args) => {
    ...
    if(!member) return message.channel.send("You must specify member to kick.");
    if(message.member === member) return message.channel.send("You can't kick yourself!");
    if(!member.kickable) return message.channel.send("You can't kick this person.");
